...
@section('content')
  <div class="container-fluid">
    ...
    <p class="mb-4 small">&nbsp&nbsp&nbsp >> 상품 내역 >> 상품 상세 >> 상품 수정</p>

    <!-- 수정창 -->
    <div class="card shadow mb-4">
      <div class="card-header py-3">
        <h6 class="m-0 font-weight-bold text-primary">[{{ $product->id }}번] 상품 수정</h6>
      </div>
      <div class="card-body mb-3">
        <form action={{ route("manage.product_manage.product_update_success") }} method="post" enctype="multipart/form-data" onsubmit="return updateID();">
          @csrf
          <div class="input-group row mb-3" style="width:50%;">
            <label for="basic-url" class="col-12 col-sm-3 col-form-label text-sm-right">상품 번호</label>
            <div class="col-12 col-sm-8 col-lg-6">
              <input type="text" class="form-control" name="product_id" readonly value="{{ $product->id }}" >
              {!! $errors->first('product_id', '<span class="form-error">:message</span>') !!}
            </div>
          </div>
          <div class="input-group row mb-3" style="width:50%;">
          ...
          <div class="input-group row mb-3" style="width:50%;">
            ...
            <div class="col-12 col-sm-8 col-lg-6">
              <input type="number" min="0" class="form-control" name="ticket" value="{{ $product->ticket }}" required readonly>
          ...
          <div class="input-group row mb-3" style="width:50%;">
            ...
            <div class="col-12 col-sm-8 col-lg-6">
              <input type="number" min="0" class="form-control" name="price" value="{{ $product->price }}" readonly>
          ...
          <div class="input-group row mb-3" style="width:50%;">
            ...
            <div class="col-12 col-sm-8 col-lg-6">
              <input type="text" min="0" class="form-control" name="code" value="{{ $product->product_code }}" required>
          ...
          <div class="input-group row mb-3" style="width:50%;">
            ...
            <div class="col-12 col-sm-8 col-lg-6">
              <div class="filebox preview-image">
                <input class="upload-name" value="{{ $product->img }}" disabled="disabled">
                <input type="hidden" name="check" value="1">
                <label for="input-file" style="margin-bottom: 0px;">업로드</label>
                <div id="input_img" style="margin-top: 5px;">
                  <div onclick="delete_img();" class="upload-display">
                    <div class="upload-thumb-wrap">
                      <img src="{{ asset("storage/img/product/".$product->img )}}" class="upload-thumb">
                    </div>
                  </div>
                </div>
...
@section('js')
  <script type="text/javascript">
    function updateID(){
      ...
      var stop = confirm("해당 상품을 수정 하시겠습니까?");
      if(!stop){
        return false;
      }
    }
